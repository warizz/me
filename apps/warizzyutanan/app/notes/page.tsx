    ...
    >
      <div>
        ...
        {paginatedNotes.length === 0 ? (
          <p className="italic">No notes yet. Start adding your notes in <code>resource/notes/</code> directory.</p>
        ) : (
          <>
            <div className="space-y-4">
              {paginatedNotes.map((note) => {
                ...
                return (
                  <div key={note.fileName} className="border-b border-gray-200 dark:border-gray-700 pb-4">
