...
export default function Home() {
  return (
    <main className="h-screen bg-white dark:bg-black text-black dark:text-white selection:bg-primary/20 selection:text-white transition-colors duration-300 overflow-hidden flex flex-col justify-between">
      ...
      <div id="main-content" className="max-w-7xl mx-auto px-4 md:px-8 py-4 md:py-8 w-full flex flex-col justify-between h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          <section aria-labelledby="logs-heading" className="min-h-0">
            <h2 id="logs-heading" className="raw-mono font-black uppercase mb-2 text-primary dark:text-primary-invert">
              [ 01 / LOGS ]
            </h2>
            <nav aria-label="Logs navigation">
              <ul className="flex flex-col">
                {LOGS.map((item) => (
                  <li key={item.url} className="border-t border-black/10 dark:border-white/10">
                    <Link
                      href={item.url}
          ...
          <section aria-labelledby="tools-heading" className="min-h-0">
            <h2 id="tools-heading" className="raw-mono font-black uppercase mb-2 text-primary dark:text-primary-invert">
              [ 02 / TOOLS ]
            </h2>
